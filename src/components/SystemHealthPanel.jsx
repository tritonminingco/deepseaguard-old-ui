            ...
            <div className="panel-body">
                <div className="data-grid data-grid-2">
                    ...
                    <div className="data-cell">
                        ...
                        <span className={`data-value status-${health.backend}`}>
                            {health.backend}
                        </span>
                    </div>
                    {/* API status */}
                    <div className="data-cell">
                        ...
                        <span className={`data-value status-${health.api}`}>
                            {health.api}
                        </span>
                    </div>
                    {/* Database status */}
                    <div className="data-cell">
                        ...
                        <span className={`data-value status-${health.db}`}>
                            {health.db}
                        </span>
                    </div>
                    {/* WebSocket status */}
                    <div className="data-cell">
                        ...
                        <span className={`data-value status-${health.ws}`}>
                            {health.ws}
                        </span>
                    </div>
                    {/* Latency */}
