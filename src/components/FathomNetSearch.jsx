            ...
            >
              <div className="species-suggestion">
                <div className="species-names">
                  <div className="scientific-name">{species.name}</div>
                  {species.commonName && (
                    <div className="common-name">{species.commonName}</div>
                  )}
                </div>
                <div className="species-info">
                  {species.phylum && (
                    <span className="phylum">{species.phylum}</span>
                  )}
                  {species.imageCount > 0 && (
                    <span className="image-count">{species.imageCount} images</span>
                  )}
                </div>
              </div>
            </div>
